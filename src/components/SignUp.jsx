...
function SignUp(props) {
  const { setEmail, setPassword, handleSignUp, email, password, signInWithGoogle, setDisplayName, err, loading } = props;
      ...
      <div className="content">
        ...
        <div className="field">
          ...
          <FaLock className="user"/>
            ...
            />
            <span className="show" onClick={ShowPass}>SHOW</span>
          </div>
